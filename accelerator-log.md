...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#buildTool == 'gradle' && #ide == 'vscode') evaluated to true
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=tanzu-java-web-app-gradle'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#nativeBuild && #buildTool == 'maven') evaluated to false
┃ ┃ ┃ ┃ ┃ ┃ ┗ null ()
